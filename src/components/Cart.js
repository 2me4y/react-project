          ...
          <>
              ...
              {cartItems.map((item, index) => (
                <li key={index} className="cart-item">
                  ...
                  <div className="cart-item__text">
                    ...
                    <p className="cart-item__price">{item.price} тг.</p>
                  </div>
                  <img
            ...
            <ul className="order-info">
              <li className="order-info__content">
                ...
                <p className="order-info__value">{itemsPrice} тг.</p>
              </li>
              <li className="order-info__content">
                <p className="order-info__title">Доставка 5%:</p>
                <div className="order-info__dots"></div>
                <p className="order-info__value">{shippingPrice} тг.</p>
              </li>
              <li className="order-info__content">
                <b className="order-info__title">Итого:</b>
                <div className="order-info__dots"></div>
                <p className="order-info__value">{totalPrice} тг.</p>
              </li>
            </ul>
